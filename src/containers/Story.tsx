...
const Years: React.FC = () => {
  ...
  return (
    <Item {...bind()} style={{ width: '350px', scale, ...props }}>
      <H2>Years Coding</H2>
      <H1>10+</H1>
    </Item>
  );
...
const StoryData = [
  { logo: elementus, focus: 'Full Stack Developer', time: '2020', primaryColor: 'rgba(121, 61, 251, 1.00)' },
  { logo: netsmart, focus: 'Software Engineer', time: '2016-2018', primaryColor: 'rgba(44, 79, 120, 1.00)' },
  { logo: rutgers, focus: 'B.A. Computer Science', time: '2016', primaryColor: 'rgba(225, 26, 55, 1.00)' },
  { logo: erre, focus: 'Head of IT and Marketing', time: '2011-2016', primaryColor: 'rgba(60, 132, 86, 1.00)'}
];
