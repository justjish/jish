...
// export const Hello:React.FC<{ skills?: typeof DATA}> = ({skills=DATA}) => {
...
//   const [style, setStyle] = useSpring({ opacity: 1, config: config.stiff }, []);
...
//       </StyledSkills>
//       <Invisible ref={topRef as any} reaching={30}/>
//       <Invisible ref={botRef as any} reaching={100}/>
//     </>
//   );
// };
