...
const fitMap = {
  [ImageFit.CONTAIN]: 'contain' as const,
  [ImageFit.COVER]: 'cover' as const,
  [ImageFit.FILL]: 'contain' as const,
  [ImageFit.INSIDE]: 'pad' as const,
  [ImageFit.OUTSIDE]: 'cover' as const,
};
