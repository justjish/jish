...
import { json as json2 } from 'react-router';
var loader2 = async ({}) => json2({ ok: !0 });
...
var loader3 = async ({ request, context }) => {
  let doesCFExistInRequest = 'cf' in request ? 'CF EXISTS IN REQUEST' : 'CF DOES NOT EXIST IN REQUEST',
    doesCFExistInContext = 'cf' in context ? 'CF EXISTS IN CONTEXT' : 'CF DOES NOT EXIST IN CONTEXT',
    propertiesOfRequest = Object.getOwnPropertyNames(request),
    propertiesOfContext = Object.getOwnPropertyNames(context);
  return new Response(
    JSON.stringify({
...
var section = 'box-border h-screen flex overflow-hidden items-center justify-center flex-col p-5',
  ...
  h1 = 'font-extrabold not-italic text-[4rem] leading-[0.7] text-[rgba(253,223,70,1)] font-acier',
  h2 = 'not-italic text-[1.25rem] whitespace-nowrap text-[rgba(8,9,69,1)] font-vag',
  h3 = 'font-extrabold not-italic uppercase text-[1.35rem] text-[rgba(136,200,255,1)] font-omnium',
  h4 = 'font-bold not-italic font-sauna',
  h3Inline = 'font-extrabold not-italic uppercase text-[2em] text-[yellow] inline font-omnium',
  row = 'w-full flex flex-wrap justify-center items-center transition duration-75 ease-in-out ',
  grid = clsx(box, 'grid grid-cols-[0.2fr_0.8fr] gap-[0.4rem]'),
  flex = clsx(box, 'flex'),
  menuBox =
...
var MenuItem = ({ icon = '', alt, lookup }) => {
  let { [lookup]: details } = useMenuSnapshot(),
    handleClick = useCallback(() => {
      window.scrollTo({ top: details.absoluteTop, left: 0, behavior: 'smooth' });
    }, [details]),
    { height, width } = useSpring2({ height: '30px', width: '30px' }),
    { bind, interactStyles } = useInteract_default({ onClick: handleClick });
...
var Menu = () => {
    ...
    return /* @__PURE__ */ jsxDEV5(
      a2.div,
      {
        className: menuBox,
        style: { width },
        children: items.map((props, index) => /* @__PURE__ */ createElement(MenuItem, { ...props, key: index })),
      },
      void 0,
      !1,
      {
...
var HelloHeading = ({ opacity, x }) => {
  let onClick = useCallback2(() => noop(), []),
    { bind, interactStyles } = useInteract_default({ onClick });
...
var Hello = ({ offset }) => {
    let [ref, bounds] = useMeasure(),
      localRef = useRef3(null),
      { setHello } = useMenuState();
    useEffect(() => {
      var _a;
    ...
    let [{ x, scale, opacity, background }] = useSpring5(
      ...
      [{ y }] = useSpring5({ y: offset.to([0, 0.2], [200, 0]), config: config3.stiff }, []),
      [{ rotateX }] = useSpring5({ rotateX: y.to([0, 100], [0, 180]), config: config3.stiff, immediate: !0 }, []);
      ...
      'div',
      {
        ...
        children: [
          /* @__PURE__ */ jsxDEV9(
            ...
            {
              className: box,
              style: { scale, y, background, zIndex: 2, position: 'absolute', rotateX },
              children: [
                /* @__PURE__ */ jsxDEV9(
                  HelloHeading,
                  { opacity, x },
...
var useMeasurementCapture = ({ preventCapture } = { preventCapture: [() => !0, []] }) => {
  let [{ originalHeight, originalWidth, isReady }, set] = useState({
      originalHeight: null,
      originalWidth: null,
      isReady: !1,
    }),
    [[cancelCapture, deps], updatePreventChange] = useState(preventCapture),
    [measureRef, bounds] = useMeasure2({ debounce: 200 }),
    localRef = useRef4(null);
  return (
    useEffect2(() => {
      !localRef.current ||
        originalHeight !== null ||
        ...
        !bounds.width ||
        cancelCapture() ||
        set({ originalHeight: bounds.height, originalWidth: bounds.width, isReady: !0 });
    }, [localRef.current, bounds, originalHeight, originalWidth, ...deps]),
    [o([measureRef, localRef]), { originalHeight, originalWidth, isReady }, updatePreventChange]
  );
};
...
var StoryContext = createContext2(null),
...
var StoryPlace = ({ id, offset, logo, focus, time, speed }) => {
  let state = useStoryState(),
    snap = useStorySnapshot(),
    onSelect = useCallback3(
      async (id2) => {
    ...
    [ref, { originalHeight, originalWidth, isReady }] = useMeasurementCapture({
  ...
  return /* @__PURE__ */ jsxDEV12(
    a8.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxDEV12(
          'div',
          { className: clsx4(h1, 'text-[8em]'), children: '10+' },
          void 0,
          !1,
          {
            fileName: 'app/components/StoryYears.tsx',
  ...
  return /* @__PURE__ */ jsxDEV14(
    'svg',
    {
      ...
      children: [
        /* @__PURE__ */ jsxDEV14(
          a10.circle,
          { cx: '-50%', cy: '50%', r, fill: 'rgba(8, 9, 69, 1.00)', className: 'mix-blend-screen' },
          void 0,
          !1,
          {
        ...
        /* @__PURE__ */ jsxDEV14(
          a10.circle,
          { className: 'mix-blend-screen', cx: '100%', cy: '50%', r, fill: 'rgba(4, 40, 110, 1.00)' },
          void 0,
          !1,
          {
            fileName: 'app/components/StoryBackground.tsx',
...
var Story = ({ data = StoryData_default, offset }) => {
    let [ref, bounds] = useMeasure3({ debounce: 200 }),
      localRef = useRef7(null),
      { setStory } = useMenuState();
    useEffect4(() => {
      var _a;
...
var BrainSkill = ({ Icon = null, idx, size, type, desc, offset }) => {
  let [{ y, color }] = useSpring10(
    {
      ...
      from: { y: 5e3, color: randomColor({ seed: type, luminosity: 'bright', alpha: 0.5 }) },
      config: {
  ...
  return /* @__PURE__ */ jsxDEV16(
    a11.div,
    {
      className: clsx6(Icon ? grid : flex),
      style: { y, color },
      children: [
        Icon &&
          /* @__PURE__ */ jsxDEV16(
...
var BrainHeading = ({ offset }) => {
  ...
  return /* @__PURE__ */ jsxDEV17(
    a12.div,
    {
      className: clsx7(h3, 'text-[2rem] sm:text-[3rem] lg:text-[3.5rem] 2xl:text-[4rem]'),
      style: { scale },
      children: [
        'an ',
        /* @__PURE__ */ jsxDEV17(
...
var Brain = ({ data = BrainData, offset }) => {
    let [ref, bounds] = useMeasure4({ debounce: 200 }),
      localRef = useRef8(null),
      { setBrain } = useMenuState();
    useEffect5(() => {
      var _a;
    ...
    return /* @__PURE__ */ jsxDEV18(
      'div',
      {
        ...
        children: [
          /* @__PURE__ */ jsxDEV18(
            'div',
            { className: clsx8(row, 'absolute h-screen overflow-hidden gap-2'), children: [...Skills] },
            void 0,
            !0,
            {
              fileName: 'app/components/Brain.tsx',
  ...
  /* @__PURE__ */ jsxDEV20(
    'div',
    {
      ...
      children: /* @__PURE__ */ jsxDEV20(
        a14.img,
        { className: 'w-screen relative', style: { scale, y }, src: cityFrameCircle_default },
        void 0,
        !1,
        {
...
var Lives = ({ offset }) => {
    let [ref, bounds] = useMeasure5(),
      localRef = useRef9(null),
      { setLives } = useMenuState();
    useEffect6(() => {
      var _a;
...
var LearnHeading = () =>
  /* @__PURE__ */ jsxDEV22(
    a15.div,
    {
      className: clsx10(h3, 'text-[1rem] sm:text-[3rem] lg:text-[3.5rem] 2xl:text-[4rem]'),
      children: [
        'More',
        /* @__PURE__ */ jsxDEV22(
          'div',
...
var LearnMessage = () =>
  /* @__PURE__ */ jsxDEV23(
    'div',
    { className: clsx11(h4, 'text-white text-[2rem] pb-10'), children: 'In the meantime ...' },
    void 0,
    !1,
    {
      ...
      children: /* @__PURE__ */ jsxDEV24(
        a16.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxDEV24(
              'div',
              { className: clsx12(h4, 'text-[0.5em]'), children: message },
              void 0,
              !1,
              {
                fileName: 'app/components/LearnExternal.tsx',
...
var Learn = ({ offset }) => {
    let [ref, bounds] = useMeasure6(),
      localRef = useRef10(null),
      { setLearn } = useMenuState();
    useEffect7(() => {
      var _a;
    ...
    let [{ opacity, scale, y }] = useSpring14(
      ...
      ExternalLinks = useMemo4(
        () => externalData.map((props, i) => /* @__PURE__ */ createElement2(LearnExternal, { ...props, key: i })),
        [],
      );
    return /* @__PURE__ */ jsxDEV25(
      'div',
      {
        ...
        children: /* @__PURE__ */ jsxDEV25(
          a17.div,
          {
            className: clsx13(box, 'overflow-hidden'),
...
var App2 = () => {
    let heightRef = useWindowHeightRef(),
      scrollPos = useScroll({}),
      [{ offset }] = useSpring15({ offset: scrollPos.scrollY.to((v) => v / heightRef.current) }, [scrollPos]);
...
var featureImage = 'https://fastly.picsum.photos/id/25/5000/3333.jpg?hmac=yCz9LeSs-i72Ru0YvvpsoECnCTxZjzGde805gWrAHkM',
  featureImage400 = 'https://fastly.picsum.photos/id/25/5000/3333.jpg?hmac=yCz9LeSs-i72Ru0YvvpsoECnCTxZjzGde805gWrAHkM',
  featureImage800 = 'https://fastly.picsum.photos/id/25/5000/3333.jpg?hmac=yCz9LeSs-i72Ru0YvvpsoECnCTxZjzGde805gWrAHkM';
function Index2() {
...
export { assets_manifest_default as assets, assetsBuildDirectory, entry, future, publicPath, routes };
