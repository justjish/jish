import { __commonJS, __esm, __toESM } from '/build/_shared/chunk-4IYZMDEG.js';
...
function createRouter(init) {
  ...
  async function startRedirectNavigation(state2, redirect3, _temp) {
    ...
    if (
      ...
      isBrowser &&
      typeof ((_window = window) == null ? void 0 : _window.location) !== 'undefined'
    ) {
  ...
  async function callLoadersAndMaybeResolveData(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
    let results = await Promise.all([
      ...matchesToLoad.map((match) => callLoaderOrAction('loader', request, match, matches, router2.basename)),
  ...
  async function loadRouteData(request, matches, requestContext, routeMatch, pendingActionError) {
    ...
    let results = await Promise.all([
      ...matchesToLoad.map((match) =>
        callLoaderOrAction('loader', request, match, matches, basename, true, isRouteRequest, requestContext),
      ),
    ]);
    if (request.signal.aborted) {
      let method = isRouteRequest ? 'queryRoute' : 'query';
...
function getMatchesToLoad(
  ...
  let defaultShouldRevalidate =
    isRevalidationRequired || currentUrl.toString() === nextUrl.toString() || currentUrl.search !== nextUrl.search;
...
function DefaultErrorElement() {
  ...
  return /* @__PURE__ */ React.createElement(
    React.Fragment,
    null,
    /* @__PURE__ */ React.createElement('h2', null, 'Unexpected Application Error!'),
    /* @__PURE__ */ React.createElement(
      'h3',
      {
        style: {
...
function useCurrentRouteId(hookName) {
  ...
  !thisRoute.route.id
    ? true
      ? invariant(false, hookName + ' can only be used on routes that contain a unique "id"')
      : invariant(false)
    : void 0;
...
function RouterProvider(_ref) {
  let { fallbackElement, router: router2 } = _ref;
...
var init_dist = __esm({
  '../../node_modules/react-router/dist/index.js'() {
    ...
    ({ useState: useState2, useEffect: useEffect2, useLayoutEffect: useLayoutEffect2, useDebugValue } = React);
...
function useSubmitImpl(fetcherKey, routeId) {
  let { router: router2 } = useDataRouterContext(DataRouterHook2.UseSubmitImpl);
...
function useScrollRestoration(_temp3) {
  ...
  let { router: router2 } = useDataRouterContext(DataRouterHook2.UseScrollRestoration);
  ...
  if (typeof document !== 'undefined') {
    ...
    React2.useLayoutEffect(() => {
      let disableScrollRestoration =
        router2 == null ? void 0 : router2.enableScrollRestoration(savedScrollPositions, () => window.scrollY, getKey);
    ...
    if (true) {
      (function () {
        ...
        var useState5 = React7.useState,
          useEffect5 = React7.useEffect,
          useLayoutEffect4 = React7.useLayoutEffect,
          useDebugValue2 = React7.useDebugValue;
...
function RemixRootDefaultErrorBoundary({ error }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement(
      ...
      /* @__PURE__ */ import_react.default.createElement('title', null, 'Application Error!'),
    ),
    /* @__PURE__ */ import_react.default.createElement(
      'body',
      null,
...
function RemixCatchBoundary({ catch: catchVal, component: Component2, children }) {
  if (catchVal) {
    return /* @__PURE__ */ import_react.default.createElement(
...
function RemixRootDefaultCatchBoundaryImpl({ caught }) {
  return /* @__PURE__ */ import_react.default.createElement(
    'html',
    {
      lang: 'en',
    ...
    /* @__PURE__ */ import_react.default.createElement(
      ...
      /* @__PURE__ */ import_react.default.createElement('title', null, 'Unhandled Thrown Response!'),
    ),
    /* @__PURE__ */ import_react.default.createElement(
      'body',
      null,
...
function isHtmlLinkDescriptor(object) {
  ...
  if (object.href == null) {
    return (
      object.rel === 'preload' &&
      (typeof object.imageSrcSet === 'string' || typeof object.imagesrcset === 'string') &&
      (typeof object.imageSizes === 'string' || typeof object.imagesizes === 'string')
    );
  }
...
function getNewMatchesForLinks(page, nextMatches, currentMatches, manifest, location, mode) {
  ...
  let matchPathChanged = (match, index) => {
    ...
    return (
      ...
      (((_currentMatches$index = currentMatches[index].route.path) === null || _currentMatches$index === void 0
        ? void 0
  ...
  let newMatches =
    mode === 'data' && location.search !== path.search
      ? nextMatches.filter((match, index) => {
          ...
          if (match.route.shouldRevalidate) {
            ...
            let routeChoice = match.route.shouldRevalidate({
              ...
              currentParams:
                ((_currentMatches$ = currentMatches[0]) === null || _currentMatches$ === void 0
                  ? void 0
      ...
      : nextMatches.filter((match, index) => {
          let manifestRoute = manifest.routes[match.route.id];
          return (
            (mode === 'assets' || manifestRoute.hasLoader) && (isNew(match, index) || matchPathChanged(match, index))
          );
        });
  return newMatches;
}
...
function RemixRoute({ id }) {
  ...
  let { default: Component2 } = routeModules[id];
  invariant2(
    Component2,
...
function RemixRouteError({ id }) {
  ...
  if (isRouteErrorResponse(error)) {
    let tError = error;
    if (
      (tError === null || tError === void 0 ? void 0 : tError.error) instanceof Error &&
      tError.status !== 404 &&
      ErrorBoundary
    ) {
...
var NavLink2 = /* @__PURE__ */ React3.forwardRef(({ to, prefetch = 'none', ...props }, forwardedRef) => {
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    shouldPrefetch && !isAbsolute
      ? /* @__PURE__ */ React3.createElement(PrefetchPageLinks, {
          page: href,
        })
      : null,
  );
...
var Link2 = /* @__PURE__ */ React3.forwardRef(({ to, prefetch = 'none', ...props }, forwardedRef) => {
  let isAbsolute = typeof to === 'string' && ABSOLUTE_URL_REGEX2.test(to);
  let href = useHref(to);
  let [shouldPrefetch, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return /* @__PURE__ */ React3.createElement(
...
function Meta() {
  ...
  return future !== null && future !== void 0 && future.v2_meta
    ? /* @__PURE__ */ React3.createElement(V2Meta, null)
    : /* @__PURE__ */ React3.createElement(V1Meta, null);
}
              ...
              .map((key) => {
                if (pendingKeys.has(key)) {
                  deferredScripts.push(
                    /* @__PURE__ */ React3.createElement(DeferredHydrationScript, {
                      key: `${routeId} | ${key}`,
                      deferredData,
                      routeId,
                      dataKey: key,
...
function DeferredHydrationScript({ dataKey, deferredData, routeId }) {
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    typeof document === 'undefined' && deferredData && dataKey && routeId
      ? /* @__PURE__ */ React3.createElement(Await2, {
          ...
          children: (data) =>
            /* @__PURE__ */ React3.createElement('script', {
              ...
              suppressHydrationWarning: true,
              dangerouslySetInnerHTML: {
                __html: `__remixContext.r(${JSON.stringify(routeId)}, ${JSON.stringify(dataKey)}, ${escapeHtml(
                  JSON.stringify(data),
                )});`,
              },
            }),
...
function ErrorDeferredHydrationScript({ dataKey, routeId }) {
  ...
  return /* @__PURE__ */ React3.createElement('script', {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: `__remixContext.r(${JSON.stringify(routeId)}, ${JSON.stringify(dataKey)}, !1, ${escapeHtml(
...
var LiveReload = false
  ? () => null
  : function LiveReload2({ port = Number(63258), timeoutMs = 1e3, nonce = void 0 }) {
      let js = String.raw;
      return /* @__PURE__ */ React3.createElement('script', {
        nonce,
        suppressHydrationWarning: true,
  ...
  return (routesByParentId[parentId] || []).map((route) => {
    ...
    let dataRoute = {
      ...
      errorElement: hasErrorBoundary
        ? /* @__PURE__ */ React4.createElement(RemixRouteError, {
            id: route.id,
          })
        : void 0,
      id: route.id,
...
function RemixBrowser(_props) {
  ...
  let location = (0, import_shim.useSyncExternalStore)(
    router.subscribe,
...
//# sourceMappingURL=/build/_shared/chunk-LVR3G7GU.js.map
