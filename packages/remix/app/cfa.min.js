!(function (e) {
  ...
  function (e, n, t) {
    ...
    !(function () {
      ...
      function n() {
        ...
        return n >= 55 && !!t && 'cellular' === t.type && t.downlinkMax <= 0.115;
      }
      function t(e) {
        ...
        for (var t in e) {
          ...
          void 0 !== n &&
            ('number' == typeof r || 'string' == typeof r
              ? (n[t] = r)
              : Array.isArray(r) && (n[t] = JSON.parse(JSON.stringify(r))));
        }
      }
      !(function () {
        function s() {
        ...
        function l(e) {
          if ('function' == typeof g.getEntriesByType) {
            ...
            (e.timingsV2 = {}),
              n &&
                n[0] &&
                (n[0].serverTiming && (t.serverTiming = n[0].serverTiming),
                n[0].nextHopProtocol && (t.nextHopProtocol = n[0].nextHopProtocol)),
              u(t, e.timingsV2);
          }
        }
        function p() {
          ...
          try {
            t =
              'function' == typeof g.getEntriesByType
                ? new URL(null === n || void 0 === n ? void 0 : n.name).pathname
                : R
                ? new URL(R).pathname
          ...
          return (
            T && (T.version && (r.versions.fl = T.version), T.icTag && (r.icTag = T.icTag), (r.siteToken = T.token)),
            A &&
              ['lcp', 'fid', 'cls', 'fcp', 'ttfb', 'inp'].forEach(function (e) {
                (r[e] = { value: -1, path: void 0 }), A[e] && void 0 !== A[e].value && (r[e] = A[e]);
              }),
            l(r),
            r
          );
        ...
        function v(r) {
          var o,
            ...
            v = {
              ...
              si: T ? T.si : 0,
              startTime: s(),
              versions: { fl: T ? T.version : '', js: '2022.10.1', timings: 1 },
              pageloadId: h,
              location: p,
              wd: d(),
            };
          if (void 0 == P) {
            if ('function' == typeof g.getEntriesByType) {
              ...
              y &&
                Array.isArray(y) &&
                y.length > 0 &&
                ((v.timingsV2 = {}), (v.versions.timings = 2), delete v.timings, u(y[0], v.timingsV2));
            }
            1 === v.versions.timings && u(a, v.timings), u(c, v.memory);
          } else l(v);
          if (
            ((v.documentWriteIntervention = n()),
            (v.firstPaint = m('first-paint')),
            (v.firstContentfulPaint = m('first-contentful-paint')),
            (v.errorCount = window.__cfErrCount || 0),
            T && (T.icTag && (v.icTag = T.icTag), (v.siteToken = T.token)),
            'function' == typeof g.getEntriesByType)
          ) {
          ...
          return (
            JSON.stringify(v).length >= 64e3 && (v.resources = []),
            void 0 !== P &&
              (delete v.timings, delete v.memory, delete v.errorCount, delete v.documentWriteIntervention),
            v
          );
        }
        function m(e) {
          ...
          if ('function' == typeof g.getEntriesByType) {
            var t =
              null === (n = g.getEntriesByType('paint')) || void 0 === n
                ? void 0
                : n.filter(function (n) {
                    return n.name === e;
                  })[0];
        ...
        var g = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance,
          y =
            ...
            ('function' == typeof document.querySelector ? document.querySelector('script[data-cf-beacon]') : void 0),
          h = c(),
          w = [],
          ...
          if (g && T && T.token) {
            ...
            document.addEventListener('visibilitychange', function () {
              if ('hidden' === document.visibilityState) {
                if (x && q()) {
                  var n = e();
                  ((null === B || void 0 === B ? void 0 : B.url) == n && null !== B && void 0 !== B && B.triggered) ||
                    M(),
                    H(n);
                }
                !O && B && ((O = !0), V());
            ...
            var A = {},
              I = function (e) {
                ...
                if (n && n.sources && n.sources.length) {
                  var t = n.sources.reduce(function (e, n) {
                    return e.node &&
                      e.previousRect.width * e.previousRect.height > n.previousRect.width * n.previousRect.height
                      ? e
                      : n;
                  });
                  if (t) return t;
              ...
              N = function (e) {
                ...
                var n = e.localName;
                return (
                  e.id && e.id.length > 0 && (n += '#' + e.id),
                  e.className && e.className.length > 0 && (n += '.' + e.className.split(' ').join('.')),
                  n
                );
              },
              k = function (e) {
                var n = window.location.pathname,
                  t = F(e.entries);
                switch (((A[e.name.toLowerCase()] = { value: e.value, path: n }), e.name)) {
                  case 'CLS':
                    (t = I(e.entries)) &&
                      A.cls &&
                      ((A.cls.element = N(t.node)),
                      (A.cls.currentRect = t.currentRect),
                      (A.cls.previousRect = t.previousRect));
                    break;
                  case 'FID':
            ...
            var x = T && (void 0 === T.spa || !0 === T.spa),
              ...
              M = function (e) {
                var n = function (e, n) {
                    (t.resources = e),
                      ...
                      T &&
                        (1 === T.r && (t.resources = []),
                        (0, o.sendObjectBeacon)('', t, function () {}, !1, j),
                        void 0 !== T.forward &&
                          void 0 !== T.forward.url &&
                          (0, o.sendObjectBeacon)('', t, function () {}, !1, T.forward.url));
                  },
                  t = v(e);
                if (t && T) {
              ...
              V = function () {
                var e = p();
                x || ((e.resources = []), delete e.tempResources),
                  T && (0, o.sendObjectBeacon)('', e, function () {}, !0, j);
              },
              D = function () {
                var n = (window.__cfRl && window.__cfRl.done) || (window.__cfQR && window.__cfQR.done);
                n ? n.then(M) : M(), (B = { id: h, url: e(), ts: new Date().getTime(), triggered: !0 });
              };
            ...
            var q = function () {
              ...
              H = function (e) {
                w.push({ id: h, url: e, ts: new Date().getTime() }), w.length > 3 && w.shift();
              };
            x &&
              ((R = e()),
              (function (n) {
                ...
                if (t) {
                  ...
                  (n.pushState = function (i, o, a) {
                    ...
                    return (
                      ...
                      u &&
                        (q() &&
                          (((null === B || void 0 === B ? void 0 : B.url) == c &&
                            null !== B &&
                            void 0 !== B &&
                            B.triggered) ||
                            M(c),
                    ...
                    window.addEventListener('popstate', function (n) {
                      q() &&
                        (((null === B || void 0 === B ? void 0 : B.url) == P &&
                          null !== B &&
                          void 0 !== B &&
                          B.triggered) ||
                          M(P),
  ...
  function (e, n, t) {
    ...
    var r,
      ...
      l = function (e, n) {
        ...
        return (
          u >= 0
            ...
            : t && (r = document.prerendering || d() > 0 ? 'prerender' : t.type.replace(/_/g, '-')),
          {
            name: e,
            value: void 0 === n ? -1 : n,
            rating: 'good',
      ...
      v = function (e, n) {
        var t = function t(r) {
          ('pagehide' !== r.type && 'hidden' !== document.visibilityState) ||
            (e(r), n && (removeEventListener('visibilitychange', t, !0), removeEventListener('pagehide', t, !0)));
        };
          ...
          a = function (e) {
            e.forEach(function (e) {
              'first-contentful-paint' === e.name &&
                (u && u.disconnect(),
                e.startTime < i.firstHiddenTime && ((o.value = e.startTime - d()), o.entries.push(e), t(!0)));
            });
          },
          c =
            window.performance &&
          ...
          u = function (e) {
            e.forEach(function (e) {
              if (!e.hadRecentInput) {
                var n = c[0],
                  t = c[c.length - 1];
                a && e.startTime - t.startTime < 1e3 && e.startTime - n.startTime < 5e3
                  ? ((a += e.value), c.push(e))
                  : ((a = e.value), (c = [e])),
      ...
      N = function (e) {
        e.forEach(function (e) {
          e.interactionId &&
            ((I = Math.min(I, e.interactionId)), (F = Math.max(F, e.interactionId)), (A = F ? (F - I) / 7 + 1 : 0));
        });
      },
      k = function () {
      ...
      x = function () {
        'interactionCount' in performance ||
          c ||
          (c = p('event', N, { type: 'event', buffered: !0, durationThreshold: 0 }));
      },
      j = 0,
      M = function () {
        return k() - j;
      ...
      H = function (e, n) {
        ...
        var r,
          ...
          o = function (e) {
            ...
            var n,
              t = ((n = Math.min(V.length - 1, Math.floor(M() / 50))), V[n]);
            t && t.latency !== i.value && ((i.value = t.latency), (i.entries = t.entries), r());
          },
          a = p('event', o, { durationThreshold: n.durationThreshold || 40 });
        (r = m(e, i, t, n.reportAllChanges)),
          a &&
  ...
  function (e, n, t) {
    ...
    function r(e, n, t) {
      ...
      if (((a[6] = (15 & a[6]) | 64), (a[8] = (63 & a[8]) | 128), n)) for (var c = 0; c < 16; ++c) n[r + c] = a[c];
      return n || o(a);
    }
    var i = t(5),
      o = t(6);
    ...
    if (r) {
      ...
      e.exports = function () {
        for (var e, n = 0; n < 16; n++)
          0 == (3 & n) && (e = 4294967296 * Math.random()), (o[n] = (e >>> ((3 & n) << 3)) & 255);
        return o;
      };
    }
  },
