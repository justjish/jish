...
import { type FC, type DetailedHTMLProps } from 'react';
import { partytownSnippet, type PartytownConfig } from '@builder.io/partytown/integration';

type ScriptProps = Exclude<DetailedHTMLProps<React.ScriptHTMLAttributes<HTMLScriptElement>, HTMLScriptElement>,"suppressHydrationWarning"|"dangerouslySetInnerHTML">
 ...
 * @public
 */
export const Partytown:FC<PartytownProps> = (props) => {
  ...
  return <script {...props?.scriptProps} suppressHydrationWarning dangerouslySetInnerHTML={{ __html: innerHTML }} />;
};
